...
public class ProductsPage extends BasePage {
	...
	/*
	 * @FindBy(xpath="(//div[@class=\"single-products\"]//p)[1]") WebElement
	...
	public String get_ProductsPage_title() {
		...
		String Products_Page_Title = DriverInitialization.getDriver().getTitle();
	...
	public void click_on_view_product() {
		BaseClass.ClickAction(DriverInitialization.getDriver(), view_product);
	...
	/*
	 * public boolean isSearchedProduct_exists(String productName) { boolean
	 * flag=false;
	 * 
	 * if(searched_product_name.getText().contains(productName)) { flag=true;
	 * 
	 * 
	 * } return flag; }
	 */
	...
	public void mousehover_click_addtocart_first() {
		...
		BaseClass.mouseOverElement(DriverInitialization.getDriver(), First_Product);
	...
	public void mousehover_click_addtocart_second() {
		BaseClass.mouseOverElement(DriverInitialization.getDriver(), Second_Product);
