...
public class ProductDetailsSteps {
	...
	public void user_navigated_to_all_products_page_successfully() throws IOException {
		...
		Assert.assertEquals(pp.get_ProductsPage_title(),
				propertiesConfig.getProperties().getProperty("products_page_title"));
		// Assert.assertEquals(pp.get_ProductsPage_title(),
		// BaseClass.getProperties().getProperty("products_page_title"));
	}
	...
	public void user_is_landed_to_product_detail_page() {
		// assert.assertEquals(pd.product_details_title(),
		// BaseClass.getProperties().getProperty("product_details_page_title"));
