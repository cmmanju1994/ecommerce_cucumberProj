...
public class VerifyProdQtyInCart 
{
	...
	ProductDetailsPage pd=new ProductDetailsPage(BaseClass.getDriver());
	...
	public void user_increase_the_quantity_to(Integer qty) throws IOException 
	{
	    ...
	    pd.enter_Productqty(BaseClass.getProperties().getProperty("qty"));
	}
	...
	public void verify_total_quanity_as_in_the_cart(Integer int1) throws IOException 
	{
	    ...
	    Assert.assertEquals(act_qty, BaseClass.getProperties().getProperty("qty"));
	}
