...
public class PlaceOrder_Register 
{
	...
	SignUpAndLoginPage sp=new SignUpAndLoginPage(BaseClass.getDriver());
	SignUpPage sup=new SignUpPage(BaseClass.getDriver());
	AccountCreatedPage accp=new AccountCreatedPage(BaseClass.getDriver());
	HomePage hp=new HomePage(BaseClass.getDriver());
	PaymentPage pmtp=new PaymentPage(BaseClass.getDriver());
	...
	{
		   sp.enter_name_signup(BaseClass.randomeString());
		   ...
		   sup.enter_password(BaseClass.randomAlphaNumeric());
		   ...
		   sup.enter_firstname(BaseClass.randomeString());
		   sup.enter_Lastname(BaseClass.randomeString());
		   sup.enter_company(BaseClass.randomeString());
		   sup.enter_addressline1(BaseClass.randomeString());
		   sup.enter_addressline2(BaseClass.randomeString());
		   sup.select_country_dropdown(5);
		   sup.enter_state(BaseClass.randomeString());
		   sup.enter_city(BaseClass.randomeString());
		   sup.enter_zip(BaseClass.randomeNumber());
		   sup.enter_mobile(BaseClass.randomeNumber());
	...
	{
		Assert.assertEquals(accp.gettext_acc_created(),"Congratulations! Your new account has been successfully created!");
	}
